...
function SignIn() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-200">
      <div className="relative w-full md:w-2/6 bg-white shadow-lg rounded-md p-5 h-full md:h-4/6">
        <div className="absolute m-4 p-1 rounded-3xl right-0 top-0 hover:bg-gray-300 cursor-pointer">
          <svg
